...
$_POST["idvalor"] = $_GET["idvalor"];

$claseCatalogos = new Catalogos();
$valor = $claseCatalogos->obtenerValor($_POST)["valor"];
...
<div style="width:500px;">
    ...
    <form id="formEditar" name="formEditar">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control requerido" name="txtNombre" id="txtNombre" placeholder="Ingresa el nombre" autocomplete="off" data-mensajeerror="Debes indicar el nombre" value="<?= $valor["nombre"] ?>">
        </div>
