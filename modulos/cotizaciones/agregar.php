                ...
                <div class="card-body">
                    <form id="formCotizacion" name="formCotizacion">
                                    ...
                                    <select name="slcCliente" id="slcCliente" class="form-control select2t" onchange="seleccionarCliente(this);">
                                        ...
                                        <?
                                            ...
                                            foreach($clientes["clientes"] as $cliente){
                                                ?>
                                                <option value="<?= $cliente["idcliente"] ?>" data-nombre="<?= $cliente["nombre"] ?>" data-correo="<?= $cliente["correo"] ?>" data-telefono="<?= $cliente["telefono"] ?>" data-idciudad="<?= $cliente["idciudad"] ?>" data-idtienda="<?= $cliente["idtienda"] ?>"><?= $cliente["nombre"] ?></option>
                                                <?
                                            }
                                        ?>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mb-3 bg-light p-3 rounded">
                                    <input type="checkbox" name="chkSubtotalizar" id="chkSubtotalizar" value="1" checked> Subtotalizar 
                                </div>
                            </div>
                        </div>
