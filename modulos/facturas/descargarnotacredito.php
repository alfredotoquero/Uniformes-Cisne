...
$idnotacredito = isset($_GET["idnotacredito"]) ? intval($_GET["idnotacredito"]) : 0;

$claseNotasCredito = new NotasCredito();
$datos = $claseNotasCredito->getZIPData($idnotacredito);
...
$tmp = tempnam(sys_get_temp_dir(), "notacredito_");
