...
?>
<form id="formColoresTallas" name="formColoresTallas" class="mt-3">
...
<script>
    $(document).ready(function(e) {
        $("#formColoresTallas .select2").select2();
    });
    ...
    function agregarColor(idcolor) {
        ...
        $("#formColoresTallas input[id='slcColor']").select2();
    ...
    function agregarTalla(idtalla) {
        ...
        $("#formColoresTallas input[id='slcTalla']").select2();
