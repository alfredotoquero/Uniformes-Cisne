...
$_POST = $_GET;
$_POST["slcAlmacenes"] = isset($_GET["slcAlmacenes"]) ? $_GET["slcAlmacenes"] : null;
$_POST["idtalla"] = $_GET["slcTalla"];
$_POST["idcolor"] = $_GET["slcColor"];
$titulo = "";


if (!is_null($_GET["slcAlmacenes"])) {
    foreach ($_GET['slcAlmacenes'] as $idalmacenn) {
        $_POST["idalmacen"] = $idalmacenn;
        $titulo .= $claseAlmacenes->obtenerAlmacen($_POST)["almacen"]["nombre"] . ", ";
    }
    $titulo = rtrim($titulo, ", ");
}
...
$pdf->Cell(176, 0, utf8_decode('Reporte de Existencias' . (($titulo != "") ? " de " . $titulo : "")), 0, 0, 'L');
$pdf->Ln(5);
...
foreach ($productos["productos"] as $producto) {
    ...
    unset($_POST["archivo"]);
    unset($_POST["contenedor"]);
    unset($_POST["txtBusqueda"]);
    // unset($_POST["slcAlmacenes"]);
    unset($_POST["slcTalla"]);
    unset($_POST["slcColor"]);
    unset($_POST["slcProveedor"]);
    unset($_POST["slcExistencias"]);
    unset($_POST["txtPrecioMin"]);
    unset($_POST["txtPrecioMax"]);
    unset($_POST["idproductos"]);
