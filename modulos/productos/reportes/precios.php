...
$pdf->Cell(176, 0, utf8_decode('Reporte de Precios' . (($titulo != "") ? " de " . $titulo : "")), 0, 0, 'L');
$pdf->Ln(5);

$pdf->SetFont('Helvetica', 'B', 9);
$pdf->Cell(106, 5, utf8_decode('Producto'), '', 0, 'L');
$pdf->Cell(35, 5, utf8_decode('Precio'), '', 0, 'L');
$pdf->Cell(50, 5, utf8_decode('Código de Barras'), '', 0, 'L');
$pdf->Ln(5);
...
foreach ($productos["productos"] as $producto) {
    ...
    $pdf->SetFont('Helvetica', '', 9);
    $pdf->Cell(106, 5, utf8_decode($producto["nombre"]), '', 0, 'L');
    $pdf->Cell(35, 5, utf8_decode("$" . number_format($producto["precio"], 2)), '', 0, 'L');
    $pdf->Cell(50, 5, utf8_decode($producto["codigobarras"]), '', 0, 'L');
    $pdf->Ln(5);
