    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Reporte de Productos Vendidos</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="mb-3 bg-light p-3 rounded">
                        <form id="formBusqueda" name="formBusqueda">
                            <input type="hidden" name="archivo" id="archivo" value="/modulos/reportes/productosvendidos/lista.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-auto">
                                    ...
                                    <button type="button" class="btn btn-info btn-sm waves-effect waves-light" name="btnImprimir" id="btnImprimir" onclick="$('#divReporte').print();">Imprimir</button>
                                </div>
                            </div>
                        </form>
                    </div>
