    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Reporte de Inventario</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="mb-3 bg-light p-3 rounded">
                        <form id="formBusqueda" name="formBusqueda">
                            <input type="hidden" name="archivo" id="archivo" value="/modulos/reportes/inventario/lista.php">
                            <input type="hidden" name="contenedor" id="contenedor" value="divLista">
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <select name="slcSucursales[]" id="slcSucursales" class="form-control select2" multiple="multiple" placeholder="--Selecciona una sucursal--">
