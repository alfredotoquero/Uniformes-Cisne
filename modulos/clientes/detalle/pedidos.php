...
<div class="box-body pt-3">
    <div class="mb-3 bg-light p-3 rounded">
        <form id="formBusqueda2" name="formBusqueda2">
            <input type="hidden" name="archivo" id="archivo" value="/modulos/clientes/detalle/pedidos/lista.php">
            <input type="hidden" name="contenedor" id="contenedor" value="divListaPedidos">
            <input type="hidden" name="tipopedido" id="tipopedido" value="<?= $_GET["modulo2"] ?>">
